 ...
 * This file demonstrates how to integrate Hashsign with a web frontend
 */

// For React/Vue/Angular applications
export class HashsignClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new HashsignClient(provider, contractAddress);
